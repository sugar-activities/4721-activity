...
class Monstruo3(pygame.sprite.Sprite):

    def __init__(self):
        pygame.sprite.Sprite.__init__(self) 
        self.image = pygame.image.load(os.path.join("imagenes", "verdad", "monstruos_-01A.png")).convert_alpha()
        self.image2 = pygame.image.load(os.path.join("imagenes", "verdad", "monstruos_-02A.png")).convert_alpha()
        self.image3 = pygame.image.load(os.path.join("imagenes", "verdad", "monstruos_-03A.png")).convert_alpha()
        self.rect = self.image.get_rect()
        self.rect.center = [(19*40+20)+172.8,(17*40+20)+37.3]
